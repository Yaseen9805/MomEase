...
import { BarChart3, Bot, Activity, Users, ShoppingBag, Music2, Stethoscope, HeartPulse, GraduationCap, TrendingUp } from "lucide-react"; // Added TrendingUp
  ...
  return (
    <div className="flex flex-col gap-8">
      <section className="rounded-lg bg-card/50 p-8 shadow-md">
        <h1 className="text-4xl font-bold tracking-tight">Welcome to MomEase!</h1>
        <p className="mt-2 text-lg text-foreground/80">
          Your companion through pregnancy and postpartum wellness.
        </p>
      </section>
