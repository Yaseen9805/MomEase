...
import type { NavLink as NavLinkType } from "@/config/nav-links";
import { iconComponents } from "@/config/nav-links";
import {
  SidebarMenu,
  SidebarMenuItem,
  SidebarMenuButton as SidebarMenuButtonPrimitive, // Renamed to avoid conflict
        ...
        return (
          <SidebarMenuItem key={link.href}>
            <SidebarMenuButton
              asChild
              isActive={isActive}
              tooltip={link.label} // Pass the label as string for tooltip content
            >
              <Link href={link.href}>
